...
La vision produit et le scope MVP sont décrits dans `docs/PRODUCT.md` — **lisez-la avant toute planification**.
...
Pour les correctifs urgents hors workflow : commit direct `fix: ...`, pas de fiche `specs/`, ajouter une entrée à `DECISIONS.md` si la décision est notable.
...
- `docs/PRODUCT.md` — vision produit, utilisateurs cibles, backlog (à lire en début de planification)
- `docs/STACK.md` — détails techniques de la stack, patterns Next 16 / Better Auth / Drizzle / Resend
- `DECISIONS.md` — journal chronologique inverse des décisions techniques structurantes
...
- **Bug urgent** → correctif direct, commit `fix:`, push, entrée `DECISIONS.md` si notable.
